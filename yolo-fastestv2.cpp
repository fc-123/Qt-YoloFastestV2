...
//    outputName2 = "796"; //11x11
    ...
    //string inputName, outputName1, outputName2;
    inputName = "input.1";
    outputName1 = "794"; //22x22
    outputName2 = "796"; //11x11
...
//	std::vector<float> bias	{3.47,35.02, 5.33,33.09, 5.35,39.54,
//							 6.66,38.45, 6.89,45.93, 8.32,47.98};
                             ...
                             std::vector<TargetBox> &dstBoxes)
{
    ...
    for (std::size_t i = 0; i < tmpBoxes.size(); i++) {
        int keep = 1;
...
{    //do result
    //numOutput为YOLO-Fastestv2中的c2、c3
